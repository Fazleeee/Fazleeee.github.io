...
// return all trailers and teaser as array
...
fetchDataFromServer(
  `https://api.themoviedb.org/3/movie/${movieId}?api_key=a58829bee1dfcfbcb3d0a27d11ebd44e&append_to_response=casts,videos,images,releases`,
  function(movie) {
    ...
    <figure class="poster-box movie-poster">
        <img src="${imageBaseURL}w342${poster_path}" class="img-cover" 
        alt="${title} poster">
    </figure>
    ...
    fetchDataFromServer(`https://api.themoviedb.org/3/movie/${movieId}/recommendations?api_key=a58829bee1dfcfbcb3d0a27d11ebd44e&page=1`,
      addSuggestedMovies);
  }
);
